# -*- coding: utf-8 -*-
"""torch ALC 权重 -> Jittor ALC 权重转换器 (在 jittor 环境运行)。

用法:
    python convert_alc_weights.py <torch_npz> <out_jt_pkl>

键名映射: torch 与 jittor 版模块属性名完全一致, 1:1 直映;
