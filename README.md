...
- ❌ **100ep 截断下终点收益未显现**：guard 实际触发的配对，100 轮终点 mIoU 低于同种子 vanilla。机制解释：平衡 BCE 阶段学到高召回/高 FA 解，回到 edgeSCE OHEM 后需重构几何，爬升慢于"原生 edgeSCE 逃离"；且 100ep 截断只吃到 15 轮 PAL 增强期；
